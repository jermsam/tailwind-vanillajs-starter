export function curryTwice(fn) { // curryTwice(fn) does the currying transform
  return function(a) {
    return function(b) {
      return fn(a, b);
    };
...
export const curriedSum = curryTwice(sum);
...
export const advancedCurriedSum = curry(total);
